			...
			public void onClick(View v) {
				if (mediaPlayerDelegate.isFullScreen) {
					...
					if (Profile.PLANTFORM == Plantform.TUDOU) {
						mSwitchPlayer
								.setImageResource(R.mipmap.plugin_ad_gofull_tudou);
					} else {
						mSwitchPlayer
								.setImageResource(R.mipmap.plugin_ad_gofull_youku);
					}
				} else {
					mBasePlayerManager.goFullScreen();
					if (Profile.PLANTFORM == Plantform.TUDOU) {
						mSwitchPlayer
								.setImageResource(R.mipmap.plugin_ad_gosmall_tudou);
					} else {
						mSwitchPlayer
								.setImageResource(R.mipmap.plugin_ad_gosmall_youku);
					}
				}
			}
		});
	...
	public void onPluginAdded() {
		...
		if (mediaPlayerDelegate.isFullScreen) {
			if (Profile.PLANTFORM == Plantform.TUDOU) {
				...
				mSwitchPlayer.setImageResource(R.mipmap.plugin_ad_gosmall_youku);
			}
		} else {
			if (Profile.PLANTFORM == Plantform.TUDOU) {
				mSwitchPlayer
				...
				mSwitchPlayer.setImageResource(R.mipmap.plugin_ad_gofull_youku);
			}
		}
		if (mediaPlayerDelegate.videoInfo.videoAdvInfo != null) {
